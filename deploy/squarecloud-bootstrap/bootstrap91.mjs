...
const generatedUrl = new URL('./.bootstrap91.generated.mjs', import.meta.url);
let source = fs.readFileSync(sourceUrl, 'utf8');

const oldRelease = "const release = 'fw70-pilot-2026-09-08.90';";
const newRelease = "const release = 'fw70-pilot-2026-09-08.91';";
...
console.log('[Jarvis World] bootstrap .91 active: git patch queue stops at 0072; premium HUD is installed directly at runtime start.');
await import(`${generatedUrl.href}?release=91`);
