...
// Square Cloud keeps application storage between deploys. Keep the runtime queue
// pinned to the validated Jarvis World snapshot through 0072, but force a fresh
// runtime release because the content of 0072 now restores the canonical synchronous
// Pointer Lock path instead of the later soft-focus bridge.
...
const generatedUrl = new URL('./.bootstrap97.generated.mjs', import.meta.url);
let source = fs.readFileSync(sourceUrl, 'utf8');

const oldRelease = "const release = 'fw70-pilot-2026-09-08.90';";
const newRelease = "const release = 'fw70-pilot-2026-09-09.97';";
...
console.log(`[Jarvis World] bootstrap .97 active: validated ${validatedRuntimePatches.length} runtime patches; synchronous canonical Pointer Lock patch is active.`);
await import(`${generatedUrl.href}?release=97`);
