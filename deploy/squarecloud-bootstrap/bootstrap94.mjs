...
const generatedUrl = new URL('./.bootstrap94.generated.mjs', import.meta.url);
let source = fs.readFileSync(sourceUrl, 'utf8');

const oldRelease = "const release = 'fw70-pilot-2026-09-08.90';";
const newRelease = "const release = 'fw70-pilot-2026-09-08.94';";
...
console.log('[Jarvis World] bootstrap .94 active: edge-steering camera, bundled local avatar and hidden legacy gizmo install at runtime start.');
await import(`${generatedUrl.href}?release=94`);
