...
const generatedUrl = new URL('./.bootstrap95.generated.mjs', import.meta.url);
let source = fs.readFileSync(sourceUrl, 'utf8');

const oldRelease = "const release = 'fw70-pilot-2026-09-08.90';";
const newRelease = "const release = 'fw70-pilot-2026-09-08.95';";
...
console.log('[Jarvis World] bootstrap .95 active: standalone camera runtime, bundled avatar and hidden gizmo install without io-manager text rewriting.');
await import(`${generatedUrl.href}?release=95`);
