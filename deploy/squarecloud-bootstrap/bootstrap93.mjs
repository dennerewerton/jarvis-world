...
const generatedUrl = new URL('./.bootstrap93.generated.mjs', import.meta.url);
let source = fs.readFileSync(sourceUrl, 'utf8');

const oldRelease = "const release = 'fw70-pilot-2026-09-08.90';";
const newRelease = "const release = 'fw70-pilot-2026-09-08.93';";
...
console.log('[Jarvis World] bootstrap .93 active: quote key uses soft camera focus without native Pointer Lock; premium HUD installs directly at runtime start.');
await import(`${generatedUrl.href}?release=93`);
